    ...
    return (
        <div className={`my-4 transition-colors duration-300 ease-in-out hover:bg-yellow-200 p-5 rounded-lg ${!isHighlighted && isExpanded ? 'bg-yellow-200' : ''}`}>
            <div className="flex justify-between items-center">
                ...
                {experienceType === "project" && githubUrl ? (
                    <a href={githubUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500 focus:outline-none">
                        GitHub
                    </a>
                ) : (
                    <button
                    ...
                    <div className="bg-white p-8 rounded-lg max-w-2xl w-full relative ">
                        <div className='overflow-y-auto overflow-x-hidden max-h-[70vh]'>
                            ...
                            {experienceType === "other" && githubUrl && (
                                <a href={githubUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500 focus:outline-none mt-4 block">
